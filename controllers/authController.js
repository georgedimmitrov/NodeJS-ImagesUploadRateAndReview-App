...
exports.forgot = async (req, res) => {
  // 1. see if user with such email exists
...
exports.confirmedPasswords = (req, res, next) => {
  if (req.body.password === req.body['password-confirm']) {
    return next(); // fine, keep it going
  }
...
exports.update = async (req, res) => {
  ...
  await req.login(updatedUser); // passport logs user in automatically if it has a user object
